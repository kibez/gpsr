...
#ifndef wialonIPS_commandsH
#define wialonIPS_commandsH
//---------------------------------------------------------------------------
#include <string>
#include <vector>
...
struct WIALONIPS_EXPORT common_t
{
...
struct WIALONIPS_EXPORT track_t
{
  bool enable;
  bool add_param;
  int interval;
...
struct WIALONIPS_EXPORT inf_t : public common_t
{
  std::string hwid;
  std::string version;
  int profile;
...
struct WIALONIPS_EXPORT zone_t : public common_t
{
  bool inside;
